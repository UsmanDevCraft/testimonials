...
const Reviewbox = ({ reviews }) => {
  const deleteReview = async (id) => {
    const response = await fetch(
      `https://testimonial-backend.vercel.app/api/reviews/deletereview/${id}`,
      {
        method: "DELETE",
        headers: {
                ...
                <div className="card-body reviewStyle">
                  ...
                  <div className="d-flex gap-3">
                    ...
                    <div className="dropdown">
                      <button
                        className="btn dropdown-toggle spaceStyle"
                        type="button"
                      ...
                      <ul className="dropdown-menu spaceStyle">
                        <li>
                          <a className="dropdown-item spaceStyle" href="#">
                            Action
                          </a>
                        </li>
                        <li>
        ...
        <div className="container d-flex justify-content-center">
          <div className="noSpaceImage">
            <img
              ...
              alt="SpaceImg"
            />
            <p>No Reviews yet, get a new one?</p>
          </div>
        </div>
      )}
    </>
